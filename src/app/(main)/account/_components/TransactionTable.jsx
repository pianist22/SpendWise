...
// // import { Check, ChevronDown, ChevronUp, Clock, MoreHorizontal, RefreshCw, Search, Trash, X } from 'lucide-react'
...
// //                     style={{color:transaction.type === "EXPENSE"?"red":"green"}}>{transaction.type === "EXPENSE"?"-":"+"}₹{transaction.amount.toFixed(2)}</TableCell>
...
const TransactionTable = ({ transactions }) => {
  ...
  useEffect(() => {
    if (deleted && !deleteLoading) {
      ...
      setSelectedIds([]); // Clear selectedIds after successful deletion **<-- Updated here**
    }
  }, [deleted, deleteLoading]);
